...
3. Вычислить общую сумму денег от продажи билетов:

   `total = 5 * n * x / 4`

4. Вывести значение `total`.
5. Конец.
...
`x` — стоимость билета второго класса.

Для вычисления общей суммы используется формула:
